...
ALTER TABLE "users" ADD COLUMN "contact_phone" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "users" ADD COLUMN "confirmation_code" text NOT NULL;--> statement-breakpoint
